    ...
    FILE_UPLOAD_RESTRICTIONS = JsonDictValue(
        {
            "audio_recording": {
                ...
                "max_duration_seconds": 60 * 60 * 3 - 30,  # 2h59:30
                "allowed_extensions": [
                    ".mp4",
                    ".m4a",
                    ".webm",
